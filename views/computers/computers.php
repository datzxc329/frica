...
<?php
$totalProducts = count($computers);
$productsPerPage = 6;
$totalPages = ceil($totalProducts / $productsPerPage);
$current_page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$offset = ($current_page - 1) * $productsPerPage;
$productsForCurrentPage = array_slice($computers, $offset, $productsPerPage);
?>
<div class="computers_section_2">
    <div class="container-fluid">
        <div class="computer_main">
            <div class="row">
                <?php foreach ($productsForCurrentPage as $computer): ?>
                    <div class="col-md-4">
                ...
                <div class="pagination">
                    <?php if ($totalPages > 1): ?>
                        <?php if ($current_page > 1): ?>
                            <a href="?controller=computers&action=computers&page=<?php echo $current_page - 1; ?>">Previous</a>
                        <?php endif; ?>
                        <?php for ($page = 1; $page <= $totalPages; $page++): ?>
                            <?php if ($page == $current_page): ?>
                                <span class="current-page"><?php echo $page; ?></span>
                            <?php else: ?>
                                <a href="?controller=computers&action=computers&page=<?php echo $page; ?>"><?php echo $page; ?></a>
                            <?php endif; ?>
                        <?php endfor; ?>
                        <?php if ($current_page < $totalPages): ?>
                            <a href="?controller=computers&action=computers&page=<?php echo $current_page + 1; ?>">Next</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
